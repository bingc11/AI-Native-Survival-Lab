...
| P04_Survival | World Simulation Core：Headless 生存模拟内核 | ✅ v2 完成（bf45fa3，15 测试绿），带学中 | dotnet test 15/15 绿 | WorldState/Clock/Commands/Event/ActionSystem 闭环 + SeededRandom/Replay/Metrics | 迁入 Unity 3D 生存 Demo 的主干 | prototypes/P04_Survival/ |
